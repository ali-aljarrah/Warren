            ...
            <div class="block-padding">
              <div class="container-fluid">
                 ...
                 <div class="col-lg-8 mx-auto text-center">
                    <div class="mx-auto">
                    <a href="/oral-surgery" class="text-decoration-none bg-soft-green rounded-3 w-18 py-2 px-2">
                          <span class="ps-3">
                     ...
                     <h1 class="dark-color-1 py-4 fs-40 fw-bold d-flex justify-content-center align-items-center">
                        Dental Implants – Warren MI
                     </h1>
                     <p class="black-color fs-16">
                         With today’s modern dental techniques & technologies, dental implants are the best choice for replacing missing teeth & restoring your smile to both beauty & functionality. We offer Zimmer dental implants to improve your quality of life!
                    </p>
                 </div>
                </div>
              </div>
