  ...
  <body>
        ...
        <div class="row">
          <div class="col-lg-8 mb-4 mb-lg-0">
            <div class="mt-4">
              ...
              Experience the difference of <br/>truly personal care!
              </h1>
              <p class="black-color fs-16">
              We are proud to serve our community and are committed to making a 
              </br>positive impact on the oral health of our patients.
              </p>
            </div>
            <div class="my-5">
            ...
            <div class="row">
              <div class="col-lg-8 mb-4 mb-lg-0">
                <div class="h-100 w-100 bg-gray rounded-4 p-4">
                  <h2 class="fs-24 fw-bold dark-color-1">We love your insurance.</h2>
                  <p class="fs-16 dark-color-1">
                  Most insured patients pay nothing out of pocket for services below:
                  </p>
                  <div class="mt-4">
                    <div class="bg-gray-1 rounded-4 py-2 px-3 w-100 mb-2">
              ...
              <div class="col-lg-4">
                <div class="h-100 d-flex flex-column justify-content-end">
                     <div class="bg-cyan rounded-4 p-4 text-end">
                      <p class="fs-16 dark-color-1 fw-600 mb-0">
          ...
          <div class="col-lg-4 bg-colu-home">
            <img class="img-fluid d-block d-lg-none mx-auto" loading="lazy" width="673" height="788" src="/assets/imgs/home/img-1.webp" alt="WARREN - Experience the difference of truly personal care!">
          </div>
        </div>
      </div>
    </section>

    <section class="py-5 bg-gray-2">
      <div class="container py-5">
        <div class="row">
          <div class="col-md-8 mx-auto">
            <div class="text-center">
              <h3 class="fs-40 dark-color-1 fw-bold mb-3">New Patient Special</h3>
              <p class="fs-16 dark-color-1 mb-4">
              ...
              <div class="row mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="text-center bg-white p-3 rounded-4">
                      <div class="fs-40 dark-color-1 fw-bold mb-2">$95</div>
                      <p class="fs-20 dark-color-1 mb-0">
                ...
                <div class="col-lg-6">
                    <div class="text-center bg-white p-3 rounded-4">
                      <div class="fs-40 dark-color-1 fw-bold mb-2">$150/Quad</div>
                      <p class="fs-20 dark-color-1 mb-0">
      ...
      <div class="container-fluid block-padding">
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="h-100 bg-cyan rounded-5 p-4 d-flex flex-column justify-content-between align-items-start">
              <div class="mb-4">
                <img class="img-fluid" loading="lazy" width="100" height="100" src="/assets/imgs/home/avatar-1.webp" alt="Warren - I'm wearing braces!">
              </div>
              <div>
                <div class="mb-3">
                  <img class="img-fluid" loading="lazy" width="226" height="55" src="/assets/imgs/invisalign.webp" alt="Warren Invisalign">
                </div>
                <div class="fs-20 dark-color-1 fw-600 mb-2">“I'm wearing braces!”</div>
                <p class="mb-0 fs-16 dark-color-1">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="h-100 bg-cyan rounded-5 p-4 d-flex flex-column justify-content-between align-items-start">
              <div class="mb-4">
                <img class="img-fluid" loading="lazy" width="100" height="100" src="/assets/imgs/home/avatar-2.webp" alt="Warren - Braces can give you a perfect smile!">
              </div>
              <div>
                <div class="fs-20 dark-color-1 fw-600 mb-2">Braces can give you a perfect smile!</div>
                <p class="mb-0 fs-16 dark-color-1">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="h-100 bg-cyan rounded-5 p-4 d-flex flex-column justify-content-between align-items-start">
              <div class="mb-4">
                <img class="img-fluid" loading="lazy" width="100" height="100" src="/assets/imgs/home/avatar-3.webp" alt="Warren - More comfortable dentistry has arrived!">
              </div>
              <div>
                <div class="mb-3">
                  <img class="img-fluid" loading="lazy" width="179" height="48" src="/assets/imgs/blolase.webp" alt="Warren Blolase">
                </div>
                <div class="fs-20 dark-color-1 fw-600 mb-2">More comfortable dentistry has arrived!</div>
                <p class="mb-0 fs-16 dark-color-1">
    ...
    <section class="py-5 my-5">
      <div class="container-fluid block-padding my-5">
        <div class="row">
          <div class="col-lg-6 mb-4 mb-lg-0">
            <div class="fs-16 dark-color-1 fw-bold mb-3">Top Dentist in Warren MI</div>
            <h4 class="fs-40 fw-bold dark-color-1 mb-4">
            Welcome to Warren Laser <br/>Dentistry!
            </h4>
            <p class="fs-16 dark-color-1">
            At Warren Laser Dentistry, we have extensive experience in all aspects of modern dentistry. We offer Comprehensive Dental Care, including everything from the Preventive Education & Routine Hygiene that help to reduce dental problems to expert Cosmetic & Restorative solutions for the dental issues our patients face.
            </p>
            <p class="fs-16 dark-color-1">
            This website is intended to provide you with basic information about our practice & the dental services we provide. If you would like to find out more about Warren Laser Dentistry or the care we provide, please  Book Your Appointment online or call us at  586-756-6351.
            </p>
            <p class="fs-16 dark-color-1">
          ...
          <div class="col-lg-6">
            ...
            <iframe class="rounded-5" width="812" height="456" loading="lazy" src="https://www.youtube.com/embed/Ew1-S3qUSLY?si=f0F_QOnSXzbI-EG1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            <div class="mt-3 text-center fs-16 dark-color-1 fw-bold">
            Appointment available after work or school & on Saturdays.
            </div>
          </div>
        </div>
    ...
    <section class="py-5 bg-gra-half d-flex justify-content-center align-items-center min-h-240">
      <div class="container-fluid block-padding">
        <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
              <div class="d-flex justify-content-center align-items-center">
                <div class="text-center blue-color fw-bold fs-32">
                Experience the Difference of Truly <br/>Personal Dental Care!
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="d-flex justify-content-center align-items-center">
                <div class="text-center white-color fw-bold fs-32">
                A Renewed Focus on Care & Convenience <br/>for Your Whole Family!
                </div>
              </div>
            </div>
        </div>
    ...
    <section class="bg-gray-2 py-5">
      <div class="container-fluid block-padding py-5">
        <div class="row">
          <div class="col-lg-6 mb-4 mb-lg-0">
              <div class="text-start text-lg-start">
                <img class="img-fluid" loading="lazy" width="673" height="437" src="/assets/imgs/home/img-2.webp" alt="Warren - We pride ourselves on not being just like every other dentist in Warren.">
              </div>
          </div>
          <div class="col-lg-6 flex-grow-1">
            <div class="d-flex align-items-center h-100">
              <div>
                <div class="fs-16 dark-color-1 fw-bold mb-3">Trusted Part of the Community</div>
                <h5 class="fs-40 fw-bold dark-color-1 mb-4">
                We pride ourselves on not being just like every other dentist in Warren.
                </h5>
        ...
        <div class="h-200"></div>
        <div class="row">
          <div class="col-lg-6 flex-grow-1 order-2 order-lg-1">
            <div class="d-flex align-items-center h-100">
              <div>
                <div class="fs-16 dark-color-1 fw-bold mb-3">Dental Implants</div>
                <h5 class="fs-40 fw-bold dark-color-1 mb-4">
          ...
          <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
              <div class="text-start text-lg-end">
                <img class="img-fluid" loading="lazy" width="673" height="437" src="/assets/imgs/home/img-3.webp" alt="Warren - Eat, Chew & Smile Naturally Again!">
              </div>
          </div>
        </div>
        <div class="h-200"></div>
        <div class="row">
          <div class="col-lg-6 mb-4 mb-lg-0">
              <div class="text-start text-lg-start">
                <img class="img-fluid" loading="lazy" width="673" height="437" src="/assets/imgs/home/img-4.webp" alt="Warren - A New Level of Respect for You & Your Family">
              </div>
          </div>
          <div class="col-lg-6 flex-grow-1">
            <div class="d-flex align-items-center h-100">
              <div>
                <div class="fs-16 dark-color-1 fw-bold mb-3">We Love Kids & Families!</div>
                <h5 class="fs-40 fw-bold dark-color-1 mb-4">
                A New Level of Respect for You & Your Family
                </h5>
                <p class="fs-16 dark-color">
        ...
        <div class="row">
          <div class="col-lg-6 flex-grow-1 order-2 order-lg-1">
            <div class="d-flex align-items-center h-100">
              <div>
                <div class="fs-16 dark-color-1 fw-bold mb-3">TEETH CLEANINGs</div>
                <h5 class="fs-40 fw-bold dark-color-1 mb-4">
          ...
          <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
              <div class="text-start text-lg-end">
                <img class="img-fluid" loading="lazy" width="673" height="437" src="/assets/imgs/home/img-5.webp" alt="Warren - Healthy Gums Lead to a Healthy Body">
              </div>
          </div>
        </div>
      </div>
