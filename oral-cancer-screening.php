                     ...
                     <p class="black-color fs-16">
                      ...
                      <div class="p-4">
                         <h5 class="soft-dark py-4 fs-24 fw-bold">
                          ...
                          <ul>
                            <li class="soft-dark">Tobacco use (smoking, chewing & dip)</li>
                            <li class="soft-dark">Excessive alcohol consumption</li>
                            <li class="soft-dark">Poor diet</li>
                            <li class="soft-dark">HPV (human papilloma virus)</li>
                            <li class="soft-dark">Age (higher risk over 40 years old)</li>
                         </ul>
                      </div>
                    </div>
