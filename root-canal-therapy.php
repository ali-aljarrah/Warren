            ...
            <div class="block-padding">
              <div class="container-fluid">
                 ...
                 <div class="col-lg-8 mx-auto text-center">
                    <div class="mx-auto">
                    <a href="/endodontics" class="text-decoration-none bg-soft-green rounded-3 w-18 py-2 px-2">
                          <span class="ps-3">
      ...
      <div class="container-fluid block-padding">
        <div class="row">
             ...
             <div class="d-flex flex-wrap">
              ...
              <a href="/pediatric-dentistry" class="text-decoration-none blue-color">
                <div class="d-flex justify-content-start align-items-center p-3 rounded border border-1 me-3 mb-3">
                  <span class="fs-16 fw-bold me-5 soft-dark ">
                     Pediatric Dentistry
                  </span>
